<template>
  <v-footer height="40" app>
    ...
    >
      &copy; 2024-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">PrivLol, LLC</span>
      —
      <a
        class="text-decoration-none on-surface"
        href="https://github.com/librelol/LibreDotLol/blob/main/LICENSE"
        rel="noopener noreferrer"
        target="_blank"
      >
        DWTFYW LICENSE
  ...
  const items = [
    {
      ...
      href: 'https://x.com/privlol',
    },
    {
      title: 'PrivLol GitHub',
      icon: `mdi-github`,
      href: 'https://github.com/vuetifyjs/vuetify',
    },
    // {
    //   title: 'PrivLol Discord',
